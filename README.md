...
Agrega las claves en `.streamlit/secrets.toml` (o en los secretos de Streamlit Cloud). Gemini se usa como principal y, si falla, la app intenta OpenAI con un modelo económico (`gpt-4o-mini`).
